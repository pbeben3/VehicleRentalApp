...
namespace VehicleRentalApp
{
    public partial class AddMotorcycle : Form
    {
        ...
        private bool validateMotorcycle()
        {
            ...
            if (Motorcycle.CheckIDAvailability(Convert.ToInt32(txtVehicleID.Text)) != true || string.IsNullOrWhiteSpace(txtVehicleID.Text))
            {
            ...
            //Type validation
            if (string.IsNullOrWhiteSpace(txtType.Text) || txtType.Text.Length < 4)
            {
            ...
            if (string.IsNullOrWhiteSpace(txtEType.Text) || txtEType.Text.Length < 2)
            {
            ...
            if (string.IsNullOrWhiteSpace(txtRLicense.Text) || txtRLicense.Text.Length < 1)
            {
